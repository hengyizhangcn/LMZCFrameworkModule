...
/**
 * Integrates CSCWebImage async downloading and caching of remote images with NSButton.
 */
...
- (void)sd_setImageWithURL:(nullable NSURL *)url
          placeholderImage:(nullable UIImage *)placeholder
                   options:(CSCWebImageOptions)options NS_REFINED_FOR_SWIFT;
...
- (void)sd_setImageWithURL:(nullable NSURL *)url
          placeholderImage:(nullable UIImage *)placeholder
                 completed:(nullable CSCExternalCompletionBlock)completedBlock NS_REFINED_FOR_SWIFT;
 ...
 * @param url         The url for the alternateImage.
 * @param placeholder The alternateImage to be set initially, until the alternateImage request finishes.
 * @param options     The options to use when downloading the alternateImage. @see CSCWebImageOptions for the possible values.
 */
- (void)sd_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder
                            options:(CSCWebImageOptions)options NS_REFINED_FOR_SWIFT;
