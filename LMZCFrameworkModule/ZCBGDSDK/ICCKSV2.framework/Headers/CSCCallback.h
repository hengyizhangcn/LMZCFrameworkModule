/*
 ...
 @brief  CSCbluetooth 的block定义和储存
...
//CSCBluettooth cancelScanBlock方法调用后的回调
typedef void (^BBCancelScanBlock)(CBCentralManager *centralManager);
//CSCBluettooth cancelAllPeripheralsConnection 方法调用后的回调
...
@interface CSCCallback : NSObject
