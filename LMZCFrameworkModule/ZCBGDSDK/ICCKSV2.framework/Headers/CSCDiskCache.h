...
/**
 A protocol to allow custom disk cache used in CSCImageCache.
 */
@protocol CSCDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull CSCImageCacheConfig *)config;
 ...
 */
@interface CSCDiskCache : NSObject <CSCDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) CSCImageCacheConfig *config;
