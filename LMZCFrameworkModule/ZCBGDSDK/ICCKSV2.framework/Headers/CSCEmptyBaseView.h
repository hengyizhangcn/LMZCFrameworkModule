...
#import "UIView+CSCEmptyViewExtension.h"

//事件回调
typedef void (^CSCActionTapBlock)(void);

@interface CSCEmptyBaseView : UIView
...
@property (nonatomic, copy, readonly) CSCActionTapBlock btnClickBlock;
@property (nonatomic,strong,readonly) UIView *customView;

/**
 emptyView点击事件
 */
@property (nonatomic, copy) CSCActionTapBlock tapEmptyViewBlock;
