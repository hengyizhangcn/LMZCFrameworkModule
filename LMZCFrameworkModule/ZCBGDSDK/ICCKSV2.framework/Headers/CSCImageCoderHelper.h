 ...
 */
@interface CSCImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<CSCImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<CSCImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage NS_SWIFT_NAME(frames(from:));
