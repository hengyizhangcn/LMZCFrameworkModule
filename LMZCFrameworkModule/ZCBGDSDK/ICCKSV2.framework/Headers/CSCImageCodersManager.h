...
/**
 ...
 Coders
 ------
 A coder must conform to the `CSCImageCoder` protocol or even to `CSCProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface CSCImageCodersManager : NSObject <CSCImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) CSCImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<CSCImageCoder>> *coders;
