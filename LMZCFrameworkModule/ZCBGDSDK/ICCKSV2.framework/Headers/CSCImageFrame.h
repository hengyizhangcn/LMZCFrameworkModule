...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `CSCImageCoderHelper`.
 @note If you need to specify animated images loop count, use `sd_imageLoopCount` property in `UIImage+CSCMetadata.h`.
 */
@interface CSCImageFrame : NSObject
