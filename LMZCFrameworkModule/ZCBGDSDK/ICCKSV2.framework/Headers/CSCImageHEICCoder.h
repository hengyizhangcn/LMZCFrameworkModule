...
/**
 ...
 @note If you need to support lower firmware version for HEIF, you can have a try at https://github.com/CSCWebImage/CSCWebImageHEIFCoder
 */
@interface CSCImageHEICCoder : CSCImageIOAnimatedCoder <CSCProgressiveImageCoder, CSCAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) CSCImageHEICCoder *sharedCoder;
