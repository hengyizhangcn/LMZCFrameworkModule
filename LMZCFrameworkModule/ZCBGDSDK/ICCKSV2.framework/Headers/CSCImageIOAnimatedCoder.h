 ...
 */
@interface CSCImageIOAnimatedCoder : NSObject <CSCProgressiveImageCoder, CSCAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `CSCImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) CSCImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kUTTypeGIF`.
 This can be used for cases when we can not detect `CSCImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
