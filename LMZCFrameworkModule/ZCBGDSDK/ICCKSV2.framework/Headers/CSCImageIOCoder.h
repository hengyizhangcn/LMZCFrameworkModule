...
/**
 ...
 For a full GIF support, we recommend `CSCAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface CSCImageIOCoder : NSObject <CSCProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) CSCImageIOCoder *sharedCoder;
