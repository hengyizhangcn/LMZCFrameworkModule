 ...
 */
FOUNDATION_EXPORT NSString * _Nullable CSCTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `CSCWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol CSCImageTransformer <NSObject>
 ...
 */
@interface CSCImagePipelineTransformer : NSObject <CSCImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<CSCImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<CSCImageTransformer>> *)transformers;

@end

// There are some built-in transformers based on the `UIImage+CSCTransformer` category to provide the common image geometry, image blending and image effect process. Those transform are useful for static image only but you can create your own to support animated image as well.
 ...
 */
@interface CSCImageRoundCornerTransformer: NSObject <CSCImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) CSCRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(CSCRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface CSCImageResizingTransformer : NSObject <CSCImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) CSCImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(CSCImageScaleMode)scaleMode;
 ...
 */
@interface CSCImageCroppingTransformer : NSObject <CSCImageTransformer>
 ...
 */
@interface CSCImageFlippingTransformer : NSObject <CSCImageTransformer>
 ...
 */
@interface CSCImageRotationTransformer : NSObject <CSCImageTransformer>
 ...
 */
@interface CSCImageTintTransformer : NSObject <CSCImageTransformer>
 ...
 */
@interface CSCImageBlurTransformer : NSObject <CSCImageTransformer>
 ...
 */
@interface CSCImageFilterTransformer: NSObject <CSCImageTransformer>
