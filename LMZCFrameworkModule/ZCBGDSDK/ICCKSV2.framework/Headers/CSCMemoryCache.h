...
@class CSCImageCacheConfig;
/**
 A protocol to allow custom memory cache used in CSCImageCache.
 */
@protocol CSCMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull CSCImageCacheConfig *)config;
 ...
 */
@interface CSCMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <CSCMemoryCache>

@property (nonatomic, strong, nonnull, readonly) CSCImageCacheConfig *config;
