...
/**
 ...
 For the description about these methods, see `CSCWebImageDownloaderOperation`
 ...
 */
@protocol CSCWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
/**
 The download operation class for CSCWebImageDownloader.
 */
@interface CSCWebImageDownloaderOperation : NSOperation <CSCWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) CSCWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) CSCWebImageContext *context;

/**
 *  Initializes a `CSCWebImageDownloaderOperation` object
 *
 *  @see CSCWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(CSCWebImageDownloaderOptions)options
                                context:(nullable CSCWebImageContext *)context NS_DESIGNATED_INITIALIZER;
