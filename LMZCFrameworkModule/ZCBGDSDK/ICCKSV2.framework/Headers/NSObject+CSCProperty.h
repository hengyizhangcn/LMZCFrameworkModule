 ...
 */
typedef void (^MJPropertiesEnumeration)(CSCProperty *property, BOOL *stop);
...
/** 用于过滤字典中的值 */
typedef id (^MJNewValueFromOldValue)(id object, id oldValue, CSCProperty *property);

/**
 * 成员属性相关的扩展
 */
@interface NSObject (CSCProperty)
#pragma mark - 遍历
/**
 *  遍历所有的成员
 */
...
+ (id)mj_getNewValueFromObject:(__unsafe_unretained id)object oldValue:(__unsafe_unretained id)oldValue property:(__unsafe_unretained CSCProperty *)property;
