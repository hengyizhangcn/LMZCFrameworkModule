...
typedef NS_ENUM(NSUInteger, CSCImageScaleMode) {
    CSCImageScaleModeFill = 0,
    CSCImageScaleModeAspectFit = 1,
    CSCImageScaleModeAspectFill = 2
};

#if CSC_UIKIT || CSC_WATCH
typedef UIRectCorner CSCRectCorner;
#else
typedef NS_OPTIONS(NSUInteger, CSCRectCorner) {
    CSCRectCornerTopLeft     = 1 << 0,
    CSCRectCornerTopRight    = 1 << 1,
    CSCRectCornerBottomLeft  = 1 << 2,
    CSCRectCornerBottomRight = 1 << 3,
    CSCRectCornerAllCorners  = ~0UL
};
#endif
