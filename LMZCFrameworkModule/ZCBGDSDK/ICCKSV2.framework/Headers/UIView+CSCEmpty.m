...
#import "UIView+CSCEmpty.h"
#import <objc/runtime.h>
#import "CSCEmptyView.h"
...
- (void)setLy_emptyView:(CSCEmptyView *)ly_emptyView{
    if (ly_emptyView != self.ly_emptyView) {
        ...
        for (UIView *view in self.subviews) {
            if ([view isKindOfClass:[CSCEmptyView class]]) {
...
- (void)ly_showEmptyView{
    ...
    NSAssert(![self isKindOfClass:[CSCEmptyView class]], @"CSCEmptyView及其子类不能调用ly_showEmptyView方法");
...
- (void)ly_hideEmptyView{
    NSAssert(![self isKindOfClass:[CSCEmptyView class]], @"CSCEmptyView及其子类不能调用ly_hideEmptyView方法");
    self.ly_emptyView.hidden = YES;
}
- (void)ly_startLoading{
    NSAssert(![self isKindOfClass:[CSCEmptyView class]], @"CSCEmptyView及其子类不能调用ly_startLoading方法");
    self.ly_emptyView.hidden = YES;
}
- (void)ly_endLoading{
    NSAssert(![self isKindOfClass:[CSCEmptyView class]], @"CSCEmptyView及其子类不能调用ly_endLoading方法");
